<!-- Stages où l'enseignant est tuteur -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-main">
        ...
        <div class="page-header">
            <h1>Voir les stages de <?= htmlspecialchars($enseignant['nom']) ?> <?= htmlspecialchars($enseignant['prenom']) ?> en tant qu'enseignant tuteur</h1>
            <p class="subtitle">Université Clermont Auvergne</p>
        </div>
        <h3><?= htmlspecialchars($enseignant['nom']) ?> <?= htmlspecialchars($enseignant['prenom']) ?> possède <?= count($StageTuteur) ?> stage(s) en tant que tuteur</h3>
    ...
    <table class="table table-striped table-bordered align-middle mb-0">
        ...
        <tbody>
            <?php foreach ($StageTuteur as $stage): ?>
                <tr>

<!-- Stages où l'enseignant est référent d'anglais -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-main">
        ...
        <div class="page-header">
            <h1>Voir les stages de <?= htmlspecialchars($enseignant['nom']) ?> <?= htmlspecialchars($enseignant['prenom']) ?> en tant qu'enseignant d'anglais</h1>
            <p class="subtitle">Université Clermont Auvergne</p>
        </div>
        <h3><?= htmlspecialchars($enseignant['nom']) ?> <?= htmlspecialchars($enseignant['prenom']) ?> possède <?= count($StageAnglais) ?> stage(s) en tant qu'enseignant d'anglais</h3>
    ...
    <table class="table table-striped table-bordered align-middle mb-0">
        ...
        <tbody>
            <?php foreach ($StageAnglais as $stage): ?>
                <tr>

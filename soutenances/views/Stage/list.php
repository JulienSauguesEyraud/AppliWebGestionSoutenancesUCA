<!-- Liste des étudiants sans stage (pour ajout) -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-main">
        ...
        <div class="page-header">
            <h1>Ajouter un stage à un étudiant</h1>
    ...
    <table class="table table-striped table-bordered align-middle mb-0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?action=addStage&idEtudiant=<?= $etudiant['IdEtudiant'] ?>">Ajouter un stage</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

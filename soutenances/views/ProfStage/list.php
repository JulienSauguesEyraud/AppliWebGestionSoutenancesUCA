<!-- Liste des étudiants avec stage mais sans tuteur/secondaire -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
        ...
        <tbody>
            <?php foreach ($etudiants as $etudiant): ?>
                <tr>
                    ...
                    <td><a href="index.php?action=addEnseignantStage&idEtudiant=<?= $etudiant['IdEtudiant'] ?>">Ajouter un enseignant tuteur et secondaire au stage</a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
